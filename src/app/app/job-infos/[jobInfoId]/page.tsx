...
const options = [
    {
        ...
        description: "Challenge yourself with practice questions tailored to yout job description.",
        href: "questions"
    },{
        label: "Practicve Interviewing",
        ...
        description: "This hould only be used for minor updates.",
        href: "edit"
    },
];
        ...
        <div className="container my-3 space-y-4">
            ...
            <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 has-hover:*:not-hover:opacity-70">
                    {options.map(option => (
                        <Link className="hover:scale-[1.02] transition-[transform_opacity]" key={option.href} href={`/app/job-infos/${jobInfoId}/${option.href}`}>
